...
elseif(CSHARP_TARGET_FRAMEWORK MATCHES ";")
    set(DOTNET_MULTI_FRAMEWORK TRUE)
endif()
...
if(DOTNET_CORE_FOUND)
  ...
  if(DOTNET_MULTI_FRAMEWORK)
    message(FATAL_ERROR "Multi-frameworks build is still Work In Progress.") 
  else()
    set(CSBUILD_CSPROJ "dotnetcore_single.csproj")
